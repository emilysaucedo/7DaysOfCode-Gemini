//Um controller é responsável por gerenciar as requisições HTTP que chegam à aplicação e decidir quais ações tomar. Ele é a "ponte" entre as rotas e a lógica de negócios.
